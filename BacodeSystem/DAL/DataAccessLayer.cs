...
namespace BacodeSystem.DAL
{
    class DataAccessLayer
    {
       public SqlConnection sqlcon;
        ...
        {
            sqlcon = new SqlConnection(@"Data Source="+Properties.Settings.Default.ServerIP+";initial Catalog="+Properties.Settings.Default.DBName+"; persist Security info=True; user id="+Properties.Settings.Default.DBUserName+";password="+Properties.Settings.Default.DBPassword+"");
